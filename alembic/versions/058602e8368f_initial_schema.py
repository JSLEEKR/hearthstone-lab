...
def upgrade() -> None:
    ...
    op.create_table('hsreplay_stats',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('deck_id', sa.Integer(), nullable=False),
    sa.Column('winrate', sa.Float(), nullable=False),
    sa.Column('playrate', sa.Float(), nullable=False),
    sa.Column('games_played', sa.Integer(), nullable=False),
    sa.Column('collected_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['deck_id'], ['decks.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('ix_hsreplay_stats_deck_date', 'hsreplay_stats', ['deck_id', 'collected_at'], unique=False)
    ...
    sa.Column('sim_winrate', sa.Float(), nullable=True),
    sa.Column('hsreplay_winrate', sa.Float(), nullable=True),
    sa.Column('combined_winrate', sa.Float(), nullable=False),
    sa.Column('recorded_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['deck_id'], ['decks.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('ix_tier_history_deck_date', 'tier_history', ['deck_id', 'recorded_at'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_tier_history_deck_date', table_name='tier_history')
    ...
    op.drop_index('ix_hsreplay_stats_deck_date', table_name='hsreplay_stats')
    op.drop_table('hsreplay_stats')
